...
public class AkshyatSecondSkystoneLeft extends org.firstinspires.ftc.teamcode.Autonomous.AutonomousLeft implements AutonomousChoice{
    public AkshyatSecondSkystoneLeft()
    {
        waitForStart();
