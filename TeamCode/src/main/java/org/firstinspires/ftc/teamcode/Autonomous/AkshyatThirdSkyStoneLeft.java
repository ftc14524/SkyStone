...
@Autonomous(name = "Akshyat Third SkyStone Left", group = "Autonomous")

public class AkshyatThirdSkyStoneLeft extends org.firstinspires.ftc.teamcode.Autonomous.AutonomousLeft implements AutonomousChoice{
    public AkshyatThirdSkyStoneLeft()
    {
        waitForStart();
